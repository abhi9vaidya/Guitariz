...
def preload_demucs():
    ...
    try:
        print("[Preload] Preloading Demucs models...")
        ...
        try:
            ...
            print(f"[ERROR] torchaudio import failed — ABI mismatch! Error: {e}")
        ...
        print("[OK] Demucs htdemucs (2-stem) model loaded successfully")
        del model
        
        # Download the htdemucs_6s model (6-stem: vocals, drums, bass, guitar, piano, other)
        model_6s = get_model("htdemucs_6s")
        print("[OK] Demucs htdemucs_6s (6-stem) model loaded successfully")
        del model_6s
        
        # Clean up to free memory
        torch.cuda.empty_cache() if torch.cuda.is_available() else None
        print("[OK] All models cached and ready for inference")
        return True
